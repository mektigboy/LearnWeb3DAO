          ...
          <div>
            {utils.parseEther(reservedCD.toString()).eq(zero) ? (
              <div>
                <input
                  ...
                  onChange={(event) => setAddEther(event.target.value || "0")}
                  className={styles.input}
                />
                <input
                  type="number"
                  placeholder="Amount Crypto Dev tokens"
                  onChange={(event) =>
                    setAddCDTokens(
                      BigNumber.from(
                        utils.parseEther(event.target.value || "0")
                      )
                    )
                  }
                  className={styles.input}
              ...
              <div>
                <input
                  ...
                  onChange={async (event) => {
                    setAddEther(event.target.value || "0");
            ...
            <div>
              <input
                ...
                onChange={async (event) => {
                  setRemoveLPTokens(event.target.value || "0");
                  await _getTokensAfterRemove(event.target.value || "0");
                }}
                className={styles.input}
              />
              <div className={styles.inputDiv}>
